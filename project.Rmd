...
authors: Yishan Zheng, Rindala Fayyad, Lauren Mock, Daniel Herrera, Yuning Liu, Jinyi
  Che
---
...
- repeat steps 1 and 2 1000 times for each desired value of d (the number of parameters)
- calculate MSE for all estimators
- check for consistency in estimators
...
temp %>% ggplot() +
  ...
  labs(x = "Number of Parameters", y = "MSE (log scale)") + 
  ggtitle("MSE vs. Number of Parameters (n = 100)")+
  scale_y_continuous(trans = "log10")+
